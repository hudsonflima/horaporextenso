...
const Footer = () => {
  ...
  return (
    <footer className="bg-white shadow m-4 dark:bg-green-800 py-2 shadow-xl shadow-green-800 rounded-xl">
      <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
        ...
        <ul className="flex flex-wrap items-center mt-3 text-sm font-medium text-green-500 dark:text-green-400 sm:mt-0">
          <li>
            <a href="https://blog-hudson.vercel.app/" className="hover:underline">Blog</a>
          </li>
        </ul>
      </div>
    </footer>
